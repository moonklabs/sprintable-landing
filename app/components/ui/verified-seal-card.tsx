    ...
    <div className={`relative ${className ?? ''}`}>
      <div
        ...
        style={{
          ...
          background:
            'linear-gradient(175deg, oklch(17% 0.02 262) 0%, oklch(15% 0.016 265) 45%)',
          boxShadow:
            '0 24px 64px oklch(13% 0.015 265 / 0.6), 0 0 80px oklch(72% 0.14 258 / 0.12), inset 0 1px 0 oklch(93% 0.02 265 / 0.05)',
        }}
      >
        ...
        <div
          ...
          style={{
            borderBottom: '1px dashed oklch(30% 0.026 265)',
        ...
        <div className="space-y-2 p-4">
          ...
          >
            ...
            <span className="min-w-0 flex-1 truncate" style={{ color: 'oklch(72% 0.025 265)' }}>
              {animatedRow.text}
            </span>
            <span
          ...
          >
            ...
            <span className="min-w-0 flex-1 truncate" style={{ color: 'oklch(65% 0.025 265)' }}>
              {gateRow.text}
            </span>
            <span className="shrink-0 font-mono text-xs" style={{ color: 'oklch(50% 0.02 265)' }}>
              {gateRow.meta}
            </span>
          </div>
      ...
      {/* Seal emblem — stamps onto the card corner on the shared 8s clock */}
      <div
        aria-hidden="true"
      ...
      >
        <span
          ...
          style={{ border: '1.5px solid oklch(65% 0.15 145 / 0.7)' }}
        />
        <SealEmblem
