...
export async function FinalCtaSection() {
  ...
  return (
    ...
    <section
      ...
      style={{
        background: "linear-gradient(160deg, oklch(35% 0.13 260), oklch(22% 0.05 265))",
      }}
    >
      ...
      <Parallax speed={0.14} className="absolute left-1/2 top-1/2 -z-10 -translate-x-1/2 -translate-y-1/2">
        <div
          ...
          style={{ background: "radial-gradient(ellipse, oklch(50% 0.16 258 / 0.22), transparent 70%)" }}
        />
      </Parallax>
